...
types: .installed
	...
	@pipenv run python .mypy/type_coverage.py 64 ./typecov/linecount.txt
...
coverage_args = --cov=pyramid_mixpanel --cov-branch --cov-report html --cov-report xml:cov.xml --cov-report term-missing --cov-fail-under=89
